...
namespace OccaSoftware.Crosshairs.Editor
{
	public class StartMenu : EditorWindow
	{
		...
		private GUIStyle header, button, contentSection;
		...
		{
			startMenu.logo = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/OccaSoftware/Crosshairs/Editor/Textures/Logo.png", typeof(Texture2D));
		}
		...
		private void DrawHeader()
		{
			...
			GUILayoutOption[] logoOptions = new GUILayoutOption[]
			{
				GUILayout.Width(230)
			};
		...
		private void DrawReviewRequest()
		{
			...
			if (GUILayout.Button("Leave a review", button, new GUILayoutOption[] { GUILayout.MaxWidth(300) }))
			{
